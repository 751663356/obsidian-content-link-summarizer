...
async function importOne(url) {
  ...
  const payload = {
    ...
    summaryApiKey,
    summaryApiBaseUrl: settings.summaryApiBaseUrl || "https://api.z.ai/api/paas/v4",
    summaryModel: settings.summaryModel || "glm-5.1",
    visionApiKey,
    visionApiBaseUrl: settings.visionApiBaseUrl || settings.summaryApiBaseUrl || "https://api.z.ai/api/paas/v4",
    visionModel: settings.visionModel || "glm-5v-turbo",
    useVisionModel: settings.useVisionModel !== false,
    transcriptionModel: settings.transcriptionModel || "gpt-4o-mini-transcribe",
